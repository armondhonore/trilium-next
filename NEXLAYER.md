# Nexlayer — trilium-next

**Live:** [https://relaxed-weasel-trilium-next.cloud.nexlayer.ai](https://relaxed-weasel-trilium-next.cloud.nexlayer.ai)  
...
**trilium-next** is deployed on [Nexlayer](https://nexlayer.ai) — a container-native
...
application:
  ...
  pods:
  - name: app
    image: mirror.gcr.io/triliumnext/notes:latest
    path: /
    servicePorts:
    - 8080
    volumes:
